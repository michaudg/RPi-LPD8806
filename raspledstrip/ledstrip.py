...
# Library defaults to GRB but you can call strand.set_channel_order(ChannelOrder)
...
class LEDStrip:
    ...
    def fill_hsv(self, h, s, v, start=0, end=-1):
    ...
    def fill_hue(self, hue, start=0, end=-1):
        self.fill(ColorHSV(hue).get_color_rgb(), start, end)

    def fill_off(self, start=0, end=-1):
